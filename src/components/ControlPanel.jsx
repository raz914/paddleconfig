            ...
            >
              <svg
                className={`w-5 h-5 transform transition-transform ${
                  environmentExpanded ? 'rotate-180' : ''
                }`}
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
                ...
                {['#ffffff', '#ffeb3b', '#ff9800', '#2196f3', '#4caf50', '#9c27b0', '#f44336', '#000000'].map((color) => (
                  <button
                    ...
                    className={`w-10 h-10 rounded-md border-2 transition-all hover:scale-110 ${
                      turfLineSettings.color === color ? 'border-gray-800 ring-2 ring-offset-2 ring-blue-400' : 'border-gray-300'
                    }`}
                  ...
                  <div className="flex gap-2 flex-wrap">
                    {['#ff6b6b', '#4ecdc4', '#45b7d1', '#f7b731', '#5f27cd', '#00d2d3', '#ffffff', '#333333'].map((color) => (
                      <button
                        ...
                        className={`w-10 h-10 rounded-md border-2 transition-all hover:scale-110 ${
                          settings.color === color ? 'border-gray-800 ring-2 ring-offset-2 ring-gray-400' : 'border-gray-300'
                        }`}
                        style={{ backgroundColor: color }}
                        title={color}
                      />
